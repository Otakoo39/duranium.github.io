...
:root {
  ...
  --baseColorVariant: #26ee07;
  --accentColor: #26ee078c;
  --accentColorr: #26ee07;
  --accentColorRGB: 81, 0, 22;
  --accentCompliment: #26ee07;
  --accentComplimentss: #26ee07;
...
#app > div.interface.text-2 > div.background {
  background: url(https://i.imgur.com/1om9I9W.jpg) center top/cover no-repeat;
  animation: loopPattern 80s linear infinite;
}

.end-modal {
  background: url(https://i.imgur.com/1om9I9W.jpg) center top/cover no-repeat !important;
}
...
#logo {
  content: url(https://i.imgur.com/4X8LEKq.png);
  width: 200px;
  height: 200px;
}
...
img.top-logo {
  content: url(https://cdn.discordapp.com/attachments/884296306460356701/942187730916483082/unknown.png) !important;
}
img.bottom-logo {
  content: url(https://cdn.discordapp.com/attachments/884296306460356701/942187730916483082/unknown.png) !important;
}
...
.play:before {
	content: "CSS by Otakoo | Last Updated 28/02/2022";
	margin-right: 30px;
}
/* Ad Block */
  #ad-bottom,
